        ...
        <CardHeader className="space-y-3">
          <div className="flex justify-center mb-4">
            <div className="rounded-full bg-indigo-500/20 p-4 ring-1 ring-indigo-500/50">
              <BotMessageSquare className="h-10 w-10 text-indigo-400" />
            </div>
          </div>
          <CardTitle className="text-3xl text-center text-white tracking-tight">Welcome Back</CardTitle>
          <CardDescription className="text-center text-slate-400">
            Sign in to access your Multi-IA Agents
          </CardDescription>
        </CardHeader>
        <CardContent>
