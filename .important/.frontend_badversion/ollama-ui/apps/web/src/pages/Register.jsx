        ...
        <div className="glass-strong rounded-[var(--radius-xl)] p-10 shadow-2xl border border-[var(--color-border)] relative overflow-hidden">
          ...
          <div className="flex flex-col items-center gap-4 mb-10 relative z-10">
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-[var(--color-muted-foreground)]">Join Multi-IA Consultant</p>
            </div>
          </div>

          <form onSubmit={handleSubmit} className="flex flex-col gap-4 relative z-10">
            <Input icon={Mail} type="email" placeholder="Email address" value={form.email} onChange={set("email")} />
            <Input icon={User} placeholder="Username" value={form.username} onChange={set("username")} />
            <Input icon={Lock} type="password" placeholder="Password" value={form.password} onChange={set("password")} />
            <Input icon={Lock} type="password" placeholder="Confirm password" value={form.confirm} onChange={set("confirm")} />
          ...
          <div className="mt-8 text-center relative z-10">
            <p className="text-sm text-[var(--color-muted-foreground)]">
              ...
              <Link to="/login" className="text-[var(--color-primary)] hover:text-[var(--color-primary-hover)] font-semibold transition-colors">
                Sign in
              </Link>
            </p>
          </div>
