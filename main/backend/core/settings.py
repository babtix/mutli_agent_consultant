...
class Settings(BaseSettings):
    ...
    DEFAULT_LLM_PROVIDER: str = "ollama"  # "ollama" or "openrouter"
    ...
    MODEL_STOP: list[str] = ["/kill","/stop","/quit","/exit","/end","/bye","/goodbye","/finish","/done","/terminer","/finir"] 
    DEBUG: bool = True
    CORS_ORIGINS: list[str] = ["http://localhost:3000", "http://localhost:5173", "http://localhost:8008"]
